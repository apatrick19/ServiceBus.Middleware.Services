...
{
   public  class BankOneAccountByAccountNoIntegration : IAccountByAccountNoIntegration
    {
        string className = "BankOneAccountByAccountNoIntegration";
       
        IApiPostAndGet apiservice;

        public BankOneAccountByAccountNoIntegration(IApiPostAndGet service)
        {
